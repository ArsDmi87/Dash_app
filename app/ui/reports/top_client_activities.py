...
TAB_STYLE = {
    ...
    "padding": "6px 18px",
    "margin": "0 6px",
    "border": f"1px solid {SPINNER_COLOR}",
    "borderRadius": "0",
}

TAB_SELECTED_STYLE = {
    "backgroundColor": SPINNER_COLOR,
    "color": "#ffffff",
    "fontWeight": "600",
    "padding": "6px 18px",
    "margin": "0 6px",
...
PANEL_STYLE = {
    ...
    "padding": "12px",
    "border": f"2px solid {CARD_BORDER_COLOR}",
                ...
                html.Div(
                    [
                        html.H5(
                            ...
                            className="panel-title text-center mb-2",
                        ),
                        ...
                        [
                            html.Div(
                                dcc.Tabs(
                                    ...
                                    value="issued",
                                    parent_className="modal-metric-tabs d-flex justify-content-center",
                                    className="metric-tabs-control",
                                    children=[
                                        dcc.Tab(
                            ...
                            html.Div(
                                dash_table.DataTable(
                                    ...
                                    style_table={
                                        ...
                                        "borderRadius": "0",
                                        "boxShadow": "none",
                                        "backgroundColor": FIGURE_BG_COLOR,
                                    },
                                    style_cell={
                                        "textAlign": "left",
                                        "whiteSpace": "normal",
...
def register_callbacks(app) -> None:
    ...
    def render_figures(store_data):
        ...
        for idx in range(MAX_CATEGORIES):
            ...
            for period in PERIODS:
                if category_entry:
                    figure = _build_period_figure(category_entry, period)
                else:
...
def _build_period_figure(category_entry: dict[str, Any], period: str) -> go.Figure:
    ...
    x_limit = max(max_positive, max_negative)
    if x_limit <= 0:
        x_limit = 1
    ...
    for label in y_positive:
        fig.add_annotation(
            ...
            xshift=-4,
            align="right",
            font=dict(size=9, family="Open Sans, Arial, sans-serif", color="#1f1f1f"),
        )
    ...
    fig.update_layout(
        title=dict(text=period_label, x=0.5, xanchor="center", y=0.98),
    )
